...
export default function Footer() {
    ...
    return (
        <motion.footer 
            className="bg-footer text-white py-8 sm:py-12 md:py-16 px-4 sm:px-6"
            initial="hidden"
            whileInView="visible"
        ...
        >
            ...
            >
                {/* Main content */}
                <motion.div 
                    className="flex flex-col lg:flex-row justify-between items-start mb-8 sm:mb-12 md:mb-16"
                    variants={staggerChildrenVariants}
                >
                    {/* Left side - Heading */}
                    <motion.div 
                        className="mb-6 sm:mb-8 lg:mb-0 w-full lg:w-2/5"
                    ...
                    >
                        ...
                        <motion.form 
                            ...
                            className="flex flex-col flex-row bg-white rounded-full p-1 gap-2 sm:gap-4"
                            variants={fadeUpVariants}
                        ...
                        >
                            ...
                            <motion.button
                                type="submit"
                                className="bg-gray-700 hover:bg-gray-600 text-white font-medium px-4 sm:px-6 py-2 rounded-full text-sm sm:text-base"
                ...
                >
                    ...
                    <motion.a
                        ...
                        className="flex items-center bg-white text-gray-900 px-6 sm:px-8 md:px-12 py-1 rounded-full overflow-hidden"
                        whileHover={{ x: 5 }}
                    >
                    ...
                    <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center bg-white text-gray-900 rounded-full px-6 sm:px-8 md:px-12 py-1 overflow-hidden"
                        whileHover={{ x: 5 }}
                    >
                ...
                {/* Copyright */}
                <motion.div 
                    className="py-4 sm:py-6 text-center text-xs sm:text-sm text-gray-500"
                    variants={fadeUpVariants}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
